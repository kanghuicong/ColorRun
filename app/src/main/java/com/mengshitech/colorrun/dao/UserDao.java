...
public class UserDao {
    ...
    public UserEntiy find(String id) {
        ...
        Cursor cursor = db
                .rawQuery("select user_id,user_name,user_pwd,user_birthday,user_sex,user_header," +
                        "user_identity,user_address,user_bankid,user_fullname,user_level,user_health," +
                        "user_height,user_weight,user_email,user_state,user_otherid,user_phone,user_sign " +
